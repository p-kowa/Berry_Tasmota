...
This repository contains two Berry scripts designed to work with Tasmota on Arduino devices.
...
1. Place the `.be` files from the `Berry/` folder in your Tasmota Berry scripts folder
